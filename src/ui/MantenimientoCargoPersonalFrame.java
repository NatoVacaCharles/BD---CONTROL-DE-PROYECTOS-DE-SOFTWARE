...
public class MantenimientoCargoPersonalFrame extends MantenimientoBaseFrame<CargoPersonal, Integer> {
    ...
    @Override
    protected CargoPersonalDAO getDao() {
        return new CargoPersonalDAO();
    }

    @Override
    protected String getTituloVentana() {
        return "Mantenimiento - CARGO PERSONAL";
    }
    ...
    @Override
    protected Object[] modelToRow(CargoPersonal model) {
    ...
    @Override
    protected void cargarModeloEnCampos(CargoPersonal model) {
    ...
    @Override
    protected CargoPersonal obtenerModeloDeCampos() throws IllegalArgumentException {
        ...
        if (estado.isEmpty())
            estado = "A";
        return new CargoPersonal(codigo, nombre, estado);
    }
    ...
    @Override
    protected Integer getCodigoFromModel(CargoPersonal model) {
        return model.getCodigo();
    }

    @Override
    protected String getNombreFromModel(CargoPersonal model) {
    ...
    protected JPanel crearPanelCampos() {
        ...
        panel.setBorder(BorderFactory.createTitledBorder("Datos del Cargo Personal"));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new MantenimientoCargoPersonalFrame().setVisible(true));
    }
}