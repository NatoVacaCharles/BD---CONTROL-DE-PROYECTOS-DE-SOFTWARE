...
public class MantenimientoEstadoProyectoFrame extends MantenimientoBaseFrame<EstadoProyecto, Integer> {
    ...
    @Override
    protected EstadoProyectoDAO getDao() {
        return new EstadoProyectoDAO();
    }

    @Override
    protected String getTituloVentana() {
        return "Mantenimiento - GZZ_ESTADO_PROYECTO";
    }
    ...
    @Override
    protected Object[] modelToRow(EstadoProyecto model) {
    ...
    @Override
    protected void cargarModeloEnCampos(EstadoProyecto model) {
    ...
    @Override
    protected EstadoProyecto obtenerModeloDeCampos() throws IllegalArgumentException {
        ...
        if (estado.isEmpty())
            estado = "A";
        return new EstadoProyecto(codigo, nombre, estado);
    }
    ...
    @Override
    protected Integer getCodigoFromModel(EstadoProyecto model) {
        return model.getCodigo();
    }

    @Override
    protected String getNombreFromModel(EstadoProyecto model) {
    ...
    protected JPanel crearPanelCampos() {
        ...
        panel.setBorder(BorderFactory.createTitledBorder("Datos del Estado Proyecto"));
    ...
    public static void main(String[] args) {
        SwingUtilities.invokeLater(() -> new MantenimientoEstadoProyectoFrame().setVisible(true));
    }
}